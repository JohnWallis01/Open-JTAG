...
//                                                   /* drSel */       0x3003, 0x400B, 0x0000, 0x1000, 0x2000, 0x2002, 0x3002, 0x400A, 0x3006, 0x1001, 0x2001, 0x3001, 0x3005, 0x4005, 0x4001, 0x400D,
//                                                   /* drCap */       0x501F, 0x3003, 0x400F, 0x0000, 0x1000, 0x1001, 0x2001, 0x400A, 0x2003, 0x400F, 0x500F, 0x600F, 0x602F, 0x700F, 0x700F, 0x706F,
//                                                   /* drShift */     0x501F, 0x3003, 0x3007, 0x4007, 0x0000, 0x1001, 0x2001, 0x3005, 0x2003, 0x400F, 0x500F, 0x600F, 0x602F, 0x700F, 0x700F, 0x706F,
//                                                   /* drEx1 */       0x400F, 0x2001, 0x2003, 0x3003, 0x4003,
//                                                   /* drPus */
//                                                   /* drEx2 */
//                                                   /* drUp */
//                                                   /* irSel */
...
void loop() {
  ...
  byte tms_data = Serial.read();
  byte tdi_data = Serial.read();
  if (tms_data == 0x30) {
